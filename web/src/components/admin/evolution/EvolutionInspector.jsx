...
const EvolutionInspector = ({ onDataChange, onSave, isSaving, catalogContext, usersManager, categories, brands }) => {
    ...
    const hideFooterModules = ['catalog', 'categories', 'pricing', 'checkout', 'users', 'customers', 'tenants', 'notifications', 'consortium'];
    ...
    return (
        ...
        >
            ...
            >
                ...
                ) : !['catalog', 'categories', 'pricing', 'checkout', 'users', 'customers', 'tenants', 'notifications', 'consortium'].includes(activeModule) ? (
