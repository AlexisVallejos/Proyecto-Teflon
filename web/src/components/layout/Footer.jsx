...
export default function Footer() {
  ...
  const whatsappNumber = settings?.branding?.footer?.socials?.whatsapp || settings?.commerce?.whatsapp_number || "";
  const instagramUrl = settings?.branding?.footer?.socials?.instagram || "#";
  const address = settings?.branding?.footer?.contact?.address || "Av. Juan B. Justo 1234, Mar del Plata";
  const phone = settings?.branding?.footer?.contact?.phone || "+54 223 123-4567";
  const email = settings?.branding?.footer?.contact?.email || "ventas@elteflon.com";
  ...
  return (
    <footer className="bg-[#181411] text-white pt-16 pb-8">
      <div className="mx-auto max-w-[1280px] px-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 border-b border-white/10 pb-12 mb-8 text-left">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-2 text-primary mb-6">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-primary"><path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8a8 8 0 0 1-10 10Z"></path><path d="M7 21a4 4 0 0 1-4-4"></path></svg>
            ...
            <p className="text-white/60 mb-6 leading-relaxed">
              Soluciones integrales en sanitarios y grifería. Calidad y confianza en cada proyecto.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-white/60">
              <li className="flex gap-3 text-left">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-primary shrink-0"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"></path><circle cx="12" cy="10" r="3"></circle></svg>
                <span>{address}</span>
              </li>
              <li className="flex gap-3 text-left">
