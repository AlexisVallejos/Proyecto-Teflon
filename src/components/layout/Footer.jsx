...
export default function Footer() {
  ...
  const whatsappNumber = String(settings?.commerce?.whatsapp_number || "").replace(
    /\D/g,
    ""
  );
  ...
  return (
    <footer className="bg-[#1b1511] text-white pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 border-b border-white/10 pb-12 mb-8">
          <div>
            ...
            <p className="text-white/60 mb-6 leading-relaxed">
              Soluciones sanitarias y de ferretería desde 1995. Calidad y servicio
              para proyectos profesionales y del hogar.
            </p>
          ...
          <div>
            <h4 className="text-lg font-bold mb-6">Accesos rápidos</h4>
          ...
          <div>
            ...
            <ul className="space-y-4 text-white/60">
              <li className="flex gap-3">
                ...
                <span>Av. Juan B. Justo 1234, Mar del Plata</span>
              </li>
              <li className="flex gap-3">
